...
const projectData = {
  ...
  'crm-erp': {
    title: 'ENTERPRISE CRM & ERP OPERATIONAL ANALYTICS FRAMEWORK',
    description: `Engineered a data integration and analytics framework connecting <b>CRM</b> and <b>ERP</b> systems to streamline the Quote-to-Cash process for custom electrical products.<br><br><b>Key Highlights</b><br><br><b>1) Data Integration & ETL</b><br>Engineered automated <b>Python and SQL ETL pipelines</b> to migrate and sync daily CRM transaction data and ERP material logs into a unified data warehouse / staging database.<br><br><b>2) Predictive & Pipeline Analytics</b><br>Developed data models to evaluate historical quotation win-loss ratios and KPIs, identifying high-margin configurations for custom products like <b>Motor Control Centers</b> and <b>APFC Panels</b>.<br><br><b>3) Inventory Forecasting</b><br>Mapped sales pipeline opportunities to multi-level <b>Bills of Materials (BOM)</b> in the ERP to perform predictive maintenance of stock levels, with automated data alerts to prevent factory floor stockouts.<br><br><b>4) Business Intelligence Reporting</b><br>Built interactive <b>Power BI</b> dashboards for senior stakeholders, tracking Lead-Time Variance, BOM Cost Slippage, and Inventory Turnover Ratios.<br><br><b>Tools:</b> Python, SQL, PostgreSQL, Power BI, ETL Pipelines, Data Integration, Data Modeling`
  },
  'loan-default': {
